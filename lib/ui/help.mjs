...
Commands:
  ...
  gc [--older-than DAYS] [--yes] Clean up stale peers, events, tasks, messages, handoffs, locks, bufs
Internal:
...
project: stale peers, and events, tasks, messages, and handoffs older than
--older-than days, plus already-expired lock rows. By default this is a dry-run;
